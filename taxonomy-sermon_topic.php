<?php
/**
 * Displays the archived (and paginated) page of sermons based on a given sermon topic
 *
 * WordPress loads this file with a url similar to:
 *     http://your-church-domain/sermons/topic/belief/
 * where 'belief' is the selected topic by the user.
 *
