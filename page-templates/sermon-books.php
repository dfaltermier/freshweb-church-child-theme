 ...
 *
 * WP page template to display sermon books.
 *
 * WordPress loads this file with a url similar to:
 *     http://your-church-domain/sermons/books/
 *
...
<div class="full_width">
    ...
    <div class="full_width_inner">
        ...
        <section class="fw-child-sermon-section">
            ...
            // Display sermons.
            FW_Child_Common_Functions::wrap_template_part(
                 FW_CHILD_THEME_PARTIALS_DIR . '/content-sermon-books'
            );
