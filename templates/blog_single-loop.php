			...
			<div class="post_content_holder">
				...
				<div class="post_text">
					<div class="post_text_inner">
					    ...
					    -->
						<h2 itemprop="name" class="entry_title"><meta itemprop="interactionCount" content="UserComments: <?php echo get_comments_number(qode_get_page_id()); ?>"/></span> <?php the_title(); ?></h2>
						<div class="post_info">
